...
class CoffeeItem {
  ...
  espresso.setImage('./assets/espresso.png');
  americano.setImage('./assets/americano.png');
  cappuccino.setImage('./assets/cappuccino.png');
  latte.setImage('./assets/latte.png');
  mocha.setImage('./assets/mocha.png');
  macchiato.setImage('./assets/macchiato.png');
